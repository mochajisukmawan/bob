                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Data Nilai Kelas <?=$kelas?> Tematik <?=$tematik?>
                        </h1>
                        <div class="row">
                            <div class="col-lg-12">
                                  ...
                                  <tbody>
                                    <?php
                                      ...
                                      <tr>
                                        ...
                                        <td><?=$benar?></td>
                                        <td><?=$salah?></td>
                                        <td><a href="http://localhost/bob/lihatdetailnilai.php?kelas=<?=$kelas?>&tematik=<?=$tematik?>&id_nilai=<?=$d_n['id_nilai']?>"><button type="button" class="btn btn-info" >Lihat</button></a></td>
                                      </tr>
                                      <?php
                                      }
                                     ?>
